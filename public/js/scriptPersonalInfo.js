...
const selectSexo = document.querySelectorAll('.divInput')[1]

selectSexo.addEventListener("change", () => {
    const option = selectSexo.children[selectSexo.selectedIndex]
    const spanSexo = selectSexo.parentElement.parentElement.parentElement.childNodes[3]
    if(option.value == "null"){
        spanSexo.textContent = "Não especifico"
    }else if(option.value == "M"){
        spanSexo.textContent = "Masculino"
    }else{
        spanSexo.textContent = "Feminino"
    }
})

const inputEmail = document.querySelectorAll('.divInput')[2]
...
const inputTelefone = document.querySelectorAll('.divInput')[3]
...
const inputEndereco = document.querySelectorAll('.divInput')[4]
